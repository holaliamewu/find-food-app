  ...
  return(
    <div className="font-[manrope]" >
      ...
      <section className="w-full py-2 fixed bottom-6 left-0 z-1000" >
        <div className="flex flex-col bg-white p-4 w-9/10 max-w-[350px] h-fit mx-auto relative transition-all border border-stone-200 shadow gap-3 rounded-[20px] font-bold text-center" >
                <h1 onClick={ () => setShowField(true)} className="flex gap-1 text-left  font-[800] cursor-pointer" >Add your fav Spot 
              { showField && 
              <svg className="absolute right-4 top-3" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x-icon lucide-x"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>}
              </h1>
            { showField && 
            (
