  ...
  return(
    <div className="font-[manrope]" >
      ...
      <section className="w-full py-2 fixed bottom-6 left-0 z-1000" >
        <div className="flex flex-col bg-white px-4 py-2 w-fit md:w-fit max-w-[350px] h-fit mx-auto relative transition-all border border-stone-200 shadow gap-3 rounded-[12px] font-bold text-center" >
